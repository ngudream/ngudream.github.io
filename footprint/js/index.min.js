...
function(a) {
	function b() {
		var b = (new Date).getTime() - new Date(2016, 01, 01, 01, 01, 0).getTime(),
			c = b % 31104e6,
			d = c % 2592e6,
			e = d % 864e5,
			f = e % 36e5;
	...
	function g() {//控件鼠标右键不可用
		document.addEventListener("keydown", function(a) {
			...
			document.title = document.hidden ? "ngudream·脚印" : "ngudream·脚印"
		})
	}
	...
	a("#next-page-for-init").bind("click", function() {
		...
		if(width < 1900 && width >= 1420){
			if(!isShowNav){
				isShowNav = true;
				$("#navgation").css("width", "120%");
			} else {
				isShowNav = false;
				$("#navgation").css("width", "100%");
			}
		}
